...
const intro = [
  "普段の業務ではモバイルアプリをつくっています。Flutter で iOS / Android のアプリを設計から実装まで手がけていて、Web は個人の制作から書きはじめました。使う人の手元でどう動くかを先に決めてから、実装の形を選ぶようにしています。",
  "個人でつくるものは、地図を扱うアプリ、記録をためるアプリなど、自分がほしいと思ったものが中心です。小さく出して、使いながら直していく進め方をしています。設計より先に触れるものをつくる、という順番を崩さないようにしています。",
  "画面の細部と文字組みが好きで、余白と罫線でどこまで説明できるかをよく考えています。このサイトも、作品のスライドショーをひとつ置くほかは、組版と 2 色だけで成立するように組みました。",
];
